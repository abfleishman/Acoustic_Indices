...
if __name__ == '__main__':
    ...
    #Set config file
    yml_file = './config/config_014_butter.yaml'

    # Read signal -------------------------------------
    filename = './data/BALMER-02_0_20150620_0445.wav'
    ...
    for index_name in ci.keys():  # iterate over the index names (key of dictionary in the yml file)
    ...
    with open('dict.csv', 'w') as f:
        ...
        for index, Index in list(file.indices.items()):
